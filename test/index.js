...
test('equals', function() {
  ...
  eq(Z.equals(Z.equals(Pair([1, 2, 3])([3, 2, 1]), Pair([1, 2, 3])([1, 2, 3]))), false);
});
...
test('bimap', function() {
  eq(Z.bimap(function(x) { return x + ' there'; }, Math.sqrt, Pair('hello')(64)),
     Pair('hello there')(8));
});
...
test('chain', function() {
  eq(Z.chain(function(n) { return Pair([n])(n + 1); }, Pair([1])(2)),
     Pair([1, 2])(3));
});
...
test('extend', function() {
  eq(Z.extend(function(pair) { return Z.extract(pair) + 1; }, Pair('forever')(99)),
     Pair('forever')(100));
});
